        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
              DBS Global Ecosystem Architecture
            </h2>
            <p className="text-lg text-muted-foreground">
              Interconnected platforms creating a sustainable digital ecosystem
            </p>
          </div>

          {/* ASCII Architecture Diagram */}
          <div className="bg-gray-900 text-gray-100 p-8 rounded-lg overflow-x-auto font-mono text-sm">
...
{`                    DBS GLOBAL
      ...
      ┌─────────────────┼─────────────────┐
      │                 │                 │
  eSmart Cart      Nature Admire    Live Life Well
  Vendor Platform   Ecosystem       Wellness Hub
      │                 │                 │
      │                 │                 │
Street Vendors    Adventure Pass   Mental Wellness
Micro Commerce    Trip Buddy App   Astro Care
GPS Vendors       Business App
      │                 │
      └────────┬────────┘
               │
         Mompreneurs Network
      ...
      (Social Impact Arm)`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-8 border border-blue-200">
              ...
              <h4 className="text-xl font-bold text-blue-900 mb-3">Commerce & Entrepreneurship</h4>
              <p className="text-blue-800 text-sm">
                eSmart Cart empowers street vendors with digital tools, GPS discovery, and AI-driven demand prediction for sustainable micro-commerce.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-8 border border-green-200">
              ...
              <h4 className="text-xl font-bold text-green-900 mb-3">Travel & Adventure</h4>
              <p className="text-green-800 text-sm">
                Nature Admire ecosystem connects travelers, manages adventure operations, and creates community through authentic travel experiences.
              </p>
            </div>

            <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg p-8 border border-pink-200">
              <div className="w-12 h-12 bg-pink-600 rounded-lg flex items-center justify-center text-white text-xl mb-4">
                💚
              </div>
              <h4 className="text-xl font-bold text-pink-900 mb-3">Wellness & Social Impact</h4>
              <p className="text-pink-800 text-sm">
                Live Life Well and OneRupee Magic focus on mental wellness, social entrepreneurship, and supporting underserved communities.
              </p>
            </div>
          </div>
        </div>
